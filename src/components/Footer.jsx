      ...
      <div className="container footer__grid">
        <div className="footer__brand">
          <div className="footer__logo">
            <img src="/straightedgelogo.png" alt={name} style={{ width: 140, height: 'auto', objectFit: 'contain', filter: 'brightness(1.1) drop-shadow(0 2px 8px rgba(0,0,0,0.5))', marginBottom: '1rem' }} />
          </div>
